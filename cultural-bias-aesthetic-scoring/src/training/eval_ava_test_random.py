...
Reads: ~/aesthetics/data/splits/test_random.csv  (2321 images, never seen)
Writes: ~/aesthetics/logs/ava_test_random_predictions.csv  (per-image preds)
...
def main():
    ...
    ds = AvaEvalSet(SPLITS_DIR / "test_random.csv")
    ...
    out_path = LOG_DIR / "ava_test_random_predictions.csv"
