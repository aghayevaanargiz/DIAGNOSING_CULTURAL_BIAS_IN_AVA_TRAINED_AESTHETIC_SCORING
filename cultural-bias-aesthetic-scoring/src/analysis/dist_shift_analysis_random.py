...
Reads:  logs/ava_test_random_predictions.csv, logs/nonwestern_predictions.csv
Writes: figures/score_distributions_random.png
        figures/calibration_widths_random.png
        logs/dist_shift_summary_random.csv
"""
...
AVA_CSV = LOG_DIR / "ava_test_random_predictions.csv"
...
def main():
    ...
    out_csv = LOG_DIR / "dist_shift_summary_random.csv"
    ...
    fig.tight_layout()
    out1 = FIG_DIR / "score_distributions_random.png"
    ...
    ax.spines[["top", "right"]].set_visible(False)
    fig.tight_layout()
    out2 = FIG_DIR / "calibration_widths_random.png"
